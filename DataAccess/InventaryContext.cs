...
namespace DataAccess
{
    public class InventaryContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder options)
        {
            ...
            {
                //options.UseSqlServer("Server=DESKTOP-1DQ6FPE; Database=InventoryDb;User Id=sa; Password=@Pepe1110");
                options.UseSqlServer("Server=tcp:dbserverinventory.database.windows.net,1433;Initial Catalog=InventoryDB;Persist Security Info=False;User ID=loperso;Password=@Pepe1110;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
